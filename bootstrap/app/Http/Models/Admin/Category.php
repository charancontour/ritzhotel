                	...
                	$html .= '<div class="dd-handle">';
						...
						//if($lavel == 0){
							$html .= '<div class="pull-right">';
								$html .= '<a href="' . url('web88cms/categories/copyCategory/' . $category['category_id']) . '" data-hover="tooltip" data-placement="top" title="Duplicate/New Category" onMouseDown="this.parentNode.parentNode.className=\'removed-dd-handle\';" onMouseUp="this.parentNode.parentNode.className=\'dd-handle\';">';
									$html .= '<span class="label label-sm label-blue"><i class="fa fa-copy"></i></span>';
								$html .= '</a> ';
								$html .= '<a href="javascript:void(0)" data-hover="tooltip" data-placement="top" onMouseDown="this.parentNode.parentNode.className=\'removed-dd-handle\';" onMouseUp="this.parentNode.parentNode.className=\'dd-handle\';" data-target="#modal-edit-category-' . $category['category_id'] . '" data-toggle="modal" title="Edit"><span class="label label-sm label-success">';
								...
								// $html .= '</a> ';
								$html .= '<a href="javascript:void(0)" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-' . $category['category_id'] . '" data-toggle="modal" onMouseDown="this.parentNode.parentNode.className=\'removed-dd-handle\';" onMouseUp="this.parentNode.parentNode.className=\'dd-handle\';">';
