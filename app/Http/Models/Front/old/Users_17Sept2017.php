...
class Users extends Model{
	...
	function sendregistrationmail($formData)
	{
		...
		$from = 'sales@ritzgardenhotel.com';
	...
	function sendsubscriptionmail($formData)
	{
		...
		$message = "Dear ".$formData['billing_first_name'].",<br><br>";
		//$message .= "This is confirmation on your successful Subscription with Ritz Garden Hotel Ipoh.<br/>";

		$message .= "This is confirmation for the successful e-news subscription with Ritz Garden Hotel Ipoh.<br><br>
