...
//   View::share('categories_menu', User::all());
// });
    ...
    Route::get('/rooms-suites/{category_name}', 'Front\RoomSuiteController@index');
    ...
    Route::get('/apartments/{category_name}', 'Front\ApartmentController@index');

    Route::get('/promotions', 'Front\PromotionController@index');
    Route::get('/promotions/{category_name}', 'Front\PromotionController@index');

    Route::get('/dining', 'Front\DiningController@index');
    Route::get('/dining/{category_name}', 'Front\DiningController@index');

    Route::get('/facilities', 'Front\FacilitiesController@index');
    Route::get('/facilities/{category_name}', 'Front\FacilitiesController@index');

    Route::get('/weddings', 'Front\WeddingController@index');
    Route::get('/weddings/{category_name}', 'Front\WeddingController@index');

    Route::get('/events-meetings', 'Front\EventMeetingController@index');
    Route::get('/events-meetings/{category_name}', 'Front\EventMeetingController@index');

    Route::get('/about-us', 'Front\AboutUsController@index');
    Route::get('/about-us/{category_name}', 'Front\AboutUsController@index');

    Route::get('/gallery', 'Front\GalleryController@index');
    Route::get('/gallery/{category_name}', 'Front\GalleryController@index');

    Route::get('/contact-us', 'Front\ContactUsController@index');
    Route::post('/contact-us/{category_name}', 'Front\ContactUsController@create');
   ...
   // Route::get('/create-account', 'Front\CreateAccountController@index');
    ...
    Route::get('/dashboard', 'Front\UserController@dashboard');
    Route::get('/accountedit', 'Front\UserController@accountEdit');
    ...
    Route::get('/orderhistory', 'Front\UserController@orderhistory');
...
//Checkout Start
    ...
    Route::get('/checkout/orderConfirmation', 'Front\CheckoutController@orderConfirmation');
//Checkout End
