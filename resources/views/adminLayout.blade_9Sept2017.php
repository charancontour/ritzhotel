    	...
    	<nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li @if(Request::path() == 'web88cms/sub_page_bannar') class="active" @endif><a href="{{ url('/web88cms/sub_page_bannar') }}"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Sub Page Banners</span></a></li>
