        ...
        <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li><a href="#"><i class="fa fa-shopping-cart fa-fw"></i><span class="menu-title">Orders</span>
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li @if(Request::path() == 'web88cms/orders') class="active" @endif><a href="{{ url('web88cms/orders') }}">View All Orders</a></li>
					...
					<li @if(preg_match('/ProductsController/',$current_route)) class="active" @endif><a href="{{ url('/web88cms/products/list/') }}"><i class="fa fa-wrench fa-fw"></i><span class="menu-title">Products</span></a></li>
					...
					<li @if(Request::path() == 'web88cms/promocodes') class="active" @endif><a href="{{ url('/web88cms/promocodes') }}"><i class="fa fa-qrcode fa-fw"></i><span class="menu-title">Promo Codes / Global Coupons</span></a></li>
