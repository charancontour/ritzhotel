          ...
          <div class="col-md-4 col-sm-6 col-xs-6">
            <div class="single-room grid"><img src="{{ asset('public/admin/products/medium/'.$products->thumbnail_image_1) }}" alt="deluxe room" class="room-thumb">
              <div class="room-info box-radius">
                ...
                <div class="room-services"> <i class="fa fa-television"></i><i class="fa fa-coffee"></i><i class="fa fa-cutlery"></i><i class="fa fa-wifi"></i></div><a href="{{route('rooms-suites/show',$products->id)}}" class="btn btn-details">more details</a>
              </div>
            </div><!--/.single-room-->
          </div><!--/.col-md-4-->
