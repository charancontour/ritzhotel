              ...
              <div class="room-info">
                ...
                <div class="room-service-area clearfix">
                  <ul class="room-services list-unstyled">
                    <li><i class="fa fa-home"></i>Room Size 350 FT<sup>2</sup></li>
                    ...
                    <li><i class="fa fa-microphone-slash"></i>Air Conditioning</li>
                    <li><i class="fa fa-eye"></i>Double Locking Doors</li>
                    <li><i class="fa fa-coffee"></i>Tea/Coffee Making Facilities</li>
                    <li><i class="fa fa-microphone-slash"></i>Room Service</li>
