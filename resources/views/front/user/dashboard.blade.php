...
<div class="room-single-area">
   ...
   <a href="{{ url('orderhistory') }}" class="pull-right"><button type="button" class="btn btn-default btn-xs">VIEW ALL <i class="fa fa-list"></i></button></a>
                         ...
                         <?php  if(count($userOrders)>0){?>
                             ...
                             <?php /*?><table class="table cart-table">
                                        <thead>
                                            <tr>
                                                <th class="table-title">Booking #</th>
                                                <th class="table-title">Date</th>
                                                <th class="table-title">Order Total</th>
                                                <th class="table-title">Payment</th>
                                                <th class="table-title">Status</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="order_details.html">#RGH-0000000003</a></td>
                                                <td>13th Jul, 2017</td>
                                                <td>RM 493.<span class="sub-price">00</span></td>
                                                <td>Visa</td>
                                                <td><span class="highlight first-color text-12px">PAID</span></td>
                                                <td><a href="order_details.html"><button type="button" class="btn btn-danger btn-xs">DETAILS <i class="fa fa-search"></i></button></a></td>
                                            </tr>
                                            <tr>
                                                <td><a href="order_details.html">#RGH-0000000002</a></td>
                                                <td>13th Jul, 2017</td>
                                                <td>RM 493.<span class="sub-price">00</span></td>
                                                <td>Mastercard</td>
                                                <td><span class="highlight third-color text-12px">PAYMENT ERROR</span></td>
                                                <td><a href="order_details.html"><button type="button" class="btn btn-danger btn-xs">DETAILS <i class="fa fa-search"></i></button></a></td>
                                            </tr>
                                            <tr>
                                                <td><a href="order_details.html">#RGH-0000000001</a></td>
                                                <td>13th Jul, 2017</td>
                                                <td>RM 493.<span class="sub-price">00</span></td>
                                                <td>Mastercard</td>
                                                <td><span class="highlight black-color text-12px">CANCELLED</span></td>
                                                <td><a href="order_details.html"><button type="button" class="btn btn-danger btn-xs">DETAILS <i class="fa fa-search"></i></button></a></td>
                                            </tr>
...
<section data-jarallax="{&quot;speed&quot;: 0.3, &quot;imgSrc&quot;: &quot;{{ asset('/public/images/parallax/bg_hotel_services.jpg')}}&quot;}" class="hotel-service-section jarallax">
              ...
              <div class="aravira-hospitality owl-carousel">
                <div class="item">
                  <div class="single-hospitality box-radius">
                    <div class="icon">
                      <img src="{{asset('/public/images/hotel_services/icon_tour_desk.png')}}" alt="Tour Desk">
                    </div>
                    <h5>Tour Desk</h5>
                ...
                <div class="item">
                  <div class="single-hospitality box-radius">
                    <div class="icon">
                      <img src="{{asset('/public/images/hotel_services/icon_reception.png')}}" alt="24 hour Reception">
                    </div>
                ...
                <div class="item">
                  <div class="single-hospitality box-radius">
                    <div class="icon">
                    	<img src="{{asset('/public/images/hotel_services/icon_wifi.png')}}" alt="WiFi">
                    </div>
                    <h5>WiFi Internet</h5>
                  </div><!--/.single-hospitality-->
                </div><!--/.item-->
                <div class="item">
                  <div class="single-hospitality box-radius">
                    <div class="icon">
                    	<img src="{{asset('/public/images/hotel_services/icon_elevator.png')}}" alt="Lift/Elevator">
                    </div>
                    <h5>Lift / Elevator</h5>
                  </div><!--/.single-hospitality-->
                </div><!--/.item-->
                ...
                <div class="item">
                  <div class="single-hospitality box-radius">
                    <div class="icon">
                    	<img src="{{asset('/public/images/hotel_services/icon_no-smoking.png')}}" alt="Non-Smoking Room">
                    </div>
                ...
                <div class="item">
                  <div class="single-hospitality box-radius">
                    <div class="icon">
                    	<img src="{{asset('/public/images/hotel_services/icon_laundry.png')}}" alt="Guest Laundry">
                    </div>
                    <h3>Guest Laundry</h3>
                  </div><!--/.single-hospitality-->
                </div><!--/.item-->
