              ...
              <tbody>
                <tr>
                  <td class="item-name-col">
                    ...
                    <td class="item-price-col"><span class="item-price-special">RM 145.<span class="sub-price">00</span></span></td>
                    <td>
                      ...
                      <td class="item-total-col"><span class="item-price-special">RM 145.<span class="sub-price">00</span></span> 
                      ...
                      <div class="tab-container left clearfix">
                        ...
                        <div class="tab-content clearfix">
                          ...
                          <div class="tab-pane active" id="discount">
                            <p>Please enter your discount coupon code here.</p>
                            <form action="#" class="review-comment-form box-radius" onsubmit="checkDiscount(this, event)">

                              <div class="single-input">
                                <div class="input box-radius">
                                  <input type="text" class="form-control input-discount" name="discount" onkeyup="activeDiscount(this)">
                      ...
                      <table class="table total-table">
                        <tbody>
                          <tr>
                            ...
                            <td class="amount"><span id="ca-sub-total">RM 513</span><span class="sub-price">.00</span></td>
                          </tr>
                          <tr>
                            <td class="total-table-title text-danger">Discount:</td>
                            <td class="amount text-danger"><span id="ca-discount">RM 0</span><span class="sub-price">.00</span></td>
                          </tr>
                          <tr>
                              <td class="total-table-title">GST (6%)</td>
                              <td class="amount"><span class="">RM 0<span class="sub-price">.00</span></span></td>
                          </tr>
                        </tbody>
                        <tfoot>
                          <tr>
                            <td>Total:</td>
                            <td class="amount-total"><span id="ca-total">RM 493</span><span class="sub-price">.00</span></td>
                          </tr>
                        </tfoot>
                      </table>
        ...
        jQuery.ajax({
            ...
            .done(function(response){
                if(response != 0){
                    ...
                    jQuery('.amount.text-danger').html('RM '+res.discount+' '+res.discount_type+'');
                    var total = Number(jQuery('#ca-total').html().replace('RM ', ''));
                    jQuery('#ca-total').html('RM '+(Number(total)-(Number(total)*(Number(res.discount)/100)))+'');
...
function calculate_sub_total(){
  ...
  total = Math.floor(sub_total-discount);
    jQuery('#ca-sub-total').html('RM '+sub_total);
    jQuery('#ca-total').html('RM '+total);
    jQuery('#ca-discount').html('RM '+discount);
}
...
?>
  ...
  function template(row){
    html = '<tr data-id="'+row.id+'" data-off="'+row.discount+'" data-price="'+row.sale_price+'" data-avail="'+row.quantity_in_stock+'">';
 ...
 html += '<td class="item-price-col"><span class="item-price-special">RM '+ row.sale_price +'.<span class="sub-price">00</span></span></td>';
 html += '<td>';
 html += '<div class="custom-quantity-input">';
 html += '<input type="text" name="quantity" value="1"> <a class="quantity-btn quantity-input-up"><i class="fa fa-angle-up"></i></a> <a class="quantity-btn quantity-input-down"><i class="fa fa-angle-down"></i></a></div>';
 html += '<span class="max-qnt" style="color:red;display:none;">Max</span>';                                            
 html += '</td>';
 html += '<td class="item-total-col"><span class="item-price-special s-b"><span class="mp">RM '+row.sale_price+'.</span><span class="sub-price">00</span></span>';
