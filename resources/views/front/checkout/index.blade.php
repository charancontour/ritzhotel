                    ...
                    <div id="respond" class="comment-respond box-radius">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="modal fade" id="modal-forgot-password" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true" style="top:auto;">
                ...
                <div class="pull-right">
                    ...
                    paypal.Button.render({
                        ...
                        onAuthorize: function(data) {
                            window.location = '{{ route('payment.status')}}'+ '?PaymentID=' + data.paymentID + '&PayerID=' + data.payerID + '&paymentToken=' + data.paymentToken;
                        },
