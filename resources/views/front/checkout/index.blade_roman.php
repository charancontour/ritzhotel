                ...
                <div class="room-comments-area" style="/* display: none; */">
                    ...
                    @endif
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 pull-right">
                                ...
                                <table class="table total-table table-responsive">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            $promo_d = isset($promo->discount)
                                                ? floor(($total_amount-$discount_price)-(($total_amount-$discount_price)/100 * $promo->discount))
                                                : floor($total_amount-$discount_price);
                                        ...
                                        <tr>
                                            ...
                                            <td class="amount"><span class="alignright">RM {{floor($total_amount/100*6)}}<span class="sub-price">.00</span></span></td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            <td><span class="alignleft">Total</span></td>
                                            <td class="amount-total"><span class="alignright">RM <?= ($promo_d+(floor($total_amount/100*6))) ?><span class="sub-price">.00</span>
                                                </span></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <hr>
                                <div class="pull-right">
                                    <a href="order_confirmation.html" class="btn btn-default">Place order &amp; Pay</a>  
                                </div>
