      ...
      <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="room-comments-area" style="
    /* display: none; */
">
                        ...
                        <form action="#" method="post" id="comment_form" name="commentForm">
                          <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 padding-right">
                              <p>
                                <input type="text" name="name" id="name" aria-required="true" placeholder="Email *" class="form-controllar">
                              </p>
                            </div><!--/.col-md-6-->
                            <div class="col-md-6 col-sm-6 padding-right">
                              <p>
                                <input type="text" name="email" id="email" aria-required="true" placeholder="Password *" class="form-controllar">
                              </p>
                            </div><!--/.col-md-6-->
                            ...
                            <div class="pull-right">
                                <a href="create_account.html" class="btn btn-default">Create an Account</a>
                            </div>
