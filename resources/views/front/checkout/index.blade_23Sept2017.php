...
<script>
    $(document).ready(function(){
        ...
        $('#toggle_anchor').attr('visibility','visible !important');
        $('#toggle_anchor').off('hover');
        $('#toggle_anchor').parent().after('<div class="clearfix" id="clearcustom"></div>');
        $('#clearcustom').after('<div class="alert-danger" style="margin-top:3%;"><span>Please sign in or sign up to place order and payment.</span></dv>');
