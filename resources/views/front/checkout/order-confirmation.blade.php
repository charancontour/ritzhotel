                        ...
                        <table class="table checkout-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <span class="item-price-special">RM {{ number_format($orderProduct->pwp_price, 2) }}</span>
                                     @else
                                     <span class="item-price-special">RM {{ number_format($orderProduct->amount, 2) }}</span>
                                     @endif
                                    </td>
                                    <td>{{ $orderProduct->quantity }}</td>
                                    <td class="item-total-col"><span class="item-price-special">RM {{ number_format(($orderProduct->quantity * $orderProduct->amount), 2) }}</span></td>
                                </tr>
                                <?php
				...
				?>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="checkout-total-price cart-total">RM {{ number_format($orderInfo->totalPrice, 2) }}</td>
                                </tr>
                            </tfoot>
                        </table>
                        <div class="md-margin"></div>
