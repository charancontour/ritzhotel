                                ...
                                <table class="table total-table table-responsive">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            $promo_d = isset($promo->discount)
                                                ? ($total_amount-$discount_price)-(($total_amount-$discount_price)/100 * $promo->discount)
                                                : $total_amount-$discount_price
                                             ?>
                                            <td class="amount text-danger"><span class="alignright">- RM <?= (($total_amount-$discount_price)/100 * $promo->discount) ?><span class="sub-price">.00</span></span></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="amount-total"><span class="alignright">RM <?= $promo_d ?>
