...
$CategoriesModel  = new App\Http\Models\Front\Categories();
$categories = $CategoriesModel->getCategories();
$footer_categories = $CategoriesModel->getParentCategories();
$header = App\Http\Models\Front\Page::getHeaderinfo();
$footer = App\Http\Models\Front\Page::getFooterinfo();
// Clean corrupted DB for footer_setup
if (isset($footer[0])) {
    echo '<pre>'; var_dump($footer); echo '</pre>';
    $footer['copyright']= $footer[0]; unset($footer[0]);
    $footer['image']	= $footer[1]; unset($footer[1]);
    $footer['icon']		= $footer[2]; unset($footer[2]);
    echo '<pre>'; var_dump($footer); echo '</pre>';
    $page = App\Http\Models\Front\Page::where('page', '=', 'footer_setup')->firstOrFail();
    $page->slider_text = serialize($footer);
    $page->save();
}
if(!isset($page_title)){
    $page_title = 'Home';
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/public/front/css/icons/font-awesome.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('/public/front/css/jquery.selectbox.css') }}"><!-- shopping cart select -->
    <link rel="stylesheet" href="{{ asset('/public/front/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('/public/front/css/responsive.css') }}">
    <link rel="stylesheet" href="{{ asset('/public/front/bootstrap_datepicker/css/datepicker.css') }}">
    ...
    <script type="text/javascript">
        ...
        function mooncake_print_state(state_id, state_index){
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12 header-inner-right">
                        ...
                        <div class="quick-contact-text"><?php echo strip_tags($header); ?></div>
                    </div>
                </div>
            </div>
...
@if(! isset($brands_scroller))
    @include('front.module.brands')
    @include('front.module.services')
@endif

<!--<footer id="footer">-->
<!--<footer id="footer" style="background-image: url({{ url('/front/images/'.$footer['image']['fg']) }})">-->
    <footer id="footer" style="background-image: url(/public/front/images/{{ $footer['image']['fg'] }})">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12 widget">
                        ...
                        <ul class="links">
                            ...
                            <li><a href="{{ url('vacancy') }}">Careers</a></li>
                            <li><a href="{{ url('services') }}">Our services</a></li>
                            <li><a href="{{ url('stores') }}">Our stores</a></li>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-12 footer-social-links-container">
                        <ul class="social-links clearfix">
                            ...
                            <?php if(isset($one['active']) and $one['active']): ?>
                    ...
                    <div class="col-md-5 col-sm-7 col-xs-12 footer-text-container pull-left">
                        <p><?php if (isset($footer['copyright']['copyright'])) echo $footer['copyright']['copyright']; ?></p>
                        Powered by: <a href="http://www.webqom.com" target="_blank">Webqom Technologies Sdn Bhd.</a>
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{ asset('/public/front/js/bootstrap-datepicker-vacancy-customized.js') }}"></script>
...
$this->WishlistModel = new App\Http\Models\Front\Wishlist();
