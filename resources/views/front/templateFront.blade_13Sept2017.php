        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              Welcome,{{ Session::get('userFirstName') }} {{ Session::get('userLastName') }}! <a href="{{ url('/logout')}}">Logout</a>
              @else
            ...
            <div class="col-md-12">
              <div class="menu-wrapper clearfix">
                <div class="navbar-header pull-left">
                  <div class="logo-block"><a href="index.html" class="site-logo"><img src="{{ asset('/public/front/images/index/logo.png') }}" alt="Ritz Garden Hotel" class="logo"></a><!--/.site-logo--></div>
                </div><!--/.navbar-header-->
