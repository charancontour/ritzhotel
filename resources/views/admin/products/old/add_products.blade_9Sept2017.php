              ...
              <div id="myTabContent" class="tab-content">
                ...
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                      ...
                      <div class="row">
                          	<div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                	<input type="text" name="sale_price" class="form-control" placeholder="0.00" value="<?php echo (isset($input['sale_price'])) ? $input['sale_price'] : '0.00'; ?>">
                                                    <div class="xss-margin"></div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                	<input type="text" name="list_price" class="form-control" placeholder="0.00" value="<?php echo (isset($input['list_price'])) ? $input['list_price'] : '0.00'; ?>">
                                                    <div class="xss-margin"></div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
														<select class="form-control" name="out_of_stock_action">
                                                            ...
                                                            <option value="signup"  <?php if(isset($input['out_of_stock_action']) && $input['out_of_stock_action'] == 'signup'){ echo 'selected="selected"'; }; ?>>Sign up for notification</option>                                                        </select>
                  ...
                  <div class="form-actions">
                      ...
                      <button type="submit" class="btn btn-red" />Add Product &nbsp;<i class="fa fa-floppy-o"></i></button>
