                    ...
                    <div class="portlet-header">
                        ...
                        <div class="btn-group">
                            ...
                            <ul role="menu" class="dropdown-menu">
                                <li><a href="#">Invoice bulk print</a></li>
                                {{--<li><a href="#">Packing slip bulk print</a></li>--}}
                                <li><a href="{{ url('web88cms/services') }}">View purchased services</a></li>
                                <li class="divider"></li>
...
//dd($order, $orderTax);
?>
                                                <td>RM {{ number_format($orderTax->total + $order->shipping_charge * 1.06, 2) }}</td>
