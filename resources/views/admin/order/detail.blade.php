    ...
    <div class="page-content">
        <div class="row">
            <div class="col-lg-12">
	            ...
	            <h5 class="block-heading pull-right">Total: <span class="text-red">RM {{ number_format($orderTax->total + $order->shipping_charge * 1.06, 2) }}</span></h5>
	            <div class="clearfix"></div>
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="btn-group">
                                                        	@if($order->status == 'Processing')
                                                            	<?php $class = "btn-info"; $text = "Processing"; ?>
                                                            @elseif($order->status == 'New Order')
                                                            	<?php $class = "btn-warning"; $text = "New Order"; ?>
                                                            @elseif($order->status == 'Ready To Ship')
                                                            	<?php $class = "btn-info"; $text = "Ready To Ship"; ?>
                                                            @elseif($order->status == 'Shipped')
                                                            	<?php $class = "btn-blue"; $text = "Shipped"; ?>
                                                            @elseif($order->status == 'Completed')
                                                            	<?php $class = "btn-success"; $text = "Completed"; ?>
                                                            @elseif($order->status == 'Declined')
                                                            	<?php $class = "btn-red"; $text = "Declined"; ?>
                                                            @elseif($order->status == 'Cancelled')
                                                            	<?php $class = "btn-primary"; $text = "Cancelled"; ?>
                                                            @endif
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="btn-group">
                                                        	...
                                                        	@elseif($order->payment_status == 'Paid')
                                                            	<?php $class = "btn-success"; $text = "Paid"; ?>
                                                            @elseif($order->payment_status == 'Payment Error')
                                                            	<?php $class = "btn-red"; $text = "Payment Error"; ?>
